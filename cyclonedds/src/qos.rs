...
impl QoS {
    ...
    pub fn with_durability(mut self, durability: policy::Durability) -> Self {
        ffi::dds_qset_durability(&mut self.inner, durability.as_ffi());
    ...
    pub fn with_durability_service(
        ...
        ffi::dds_qset_durability_service(
            &mut self.inner,
            service_cleanup_delay,
            history_kind,
            history_depth,
    ...
    pub fn with_deadline(mut self, deadline: policy::Deadline) -> Self {
        ...
        ffi::dds_qset_deadline(&mut self.inner, period);
    ...
    pub fn with_latency_budget(mut self, latency_budget: policy::LatencyBudget) -> Self {
        ...
        ffi::dds_qset_latency_budget(&mut self.inner, duration);
    ...
    pub fn with_ownership(mut self, ownership: policy::Ownership) -> Self {
        match &ownership {
            ...
            policy::Ownership::Exclusive { strength } => {
                ...
                ffi::dds_qset_ownership_strength(&mut self.inner, *strength);
            }
        }
    ...
    pub fn with_liveliness(mut self, liveliness: policy::Liveliness) -> Self {
        ...
        ffi::dds_qset_liveliness(&mut self.inner, kind, lease_duration);
    ...
    pub fn with_time_based_filter(mut self, time_based_filter: policy::TimeBasedFilter) -> Self {
        ...
        ffi::dds_qset_time_based_filter(&mut self.inner, minimum_separation);
    ...
    pub fn with_partition(mut self, partition: policy::Partition) -> Self {
        ...
        ffi::dds_qset_partition(&mut self.inner, partitions);
    ...
    pub fn with_reliability(mut self, reliability: policy::Reliability) -> Self {
        ...
        ffi::dds_qset_reliability(&mut self.inner, kind, max_blocking_time);
    ...
    pub fn with_transport_priority(
        ...
        ffi::dds_qset_transport_priority(&mut self.inner, lifespan);
    ...
    pub fn with_lifespan(mut self, lifespan: policy::Lifespan) -> Self {
        ...
        ffi::dds_qset_lifespan(&mut self.inner, duration);
    ...
    pub fn with_destination_order(mut self, destination_order: policy::DestinationOrder) -> Self {
        ...
        ffi::dds_qset_destination_order(&mut self.inner, kind);
    ...
    pub fn with_history(mut self, history: policy::History) -> Self {
        ...
        ffi::dds_qset_history(&mut self.inner, kind, depth);
    ...
    pub fn with_entity_factory(mut self, entity_factory: policy::EntityFactory) -> Self {
        ...
        ffi::dds_qset_entity_factory(&mut self.inner, auto_enable_created_entities);
    ...
    pub fn with_writer_data_lifecycle(
        ...
        ffi::dds_qset_writer_data_lifecycle(&mut self.inner, autodispose);
    ...
    pub fn with_reader_data_lifecycle(
        ...
        ffi::dds_qset_reader_data_lifecycle(
            &mut self.inner,
...
impl Drop for QoS {
    fn drop(&mut self) {
        // Clear the partitions (which will cause Cyclone to free the memory in the QoS).
        ffi::dds_qset_partition(&mut self.inner, Vec::new());
    }
}
