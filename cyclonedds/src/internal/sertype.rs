...
impl<T> Sertype<T>
where
    T: std::clone::Clone + serde::ser::Serialize + serde::de::DeserializeOwned + Default,
{
    const SERTYPE_OPS: cyclonedds_sys::ddsi_sertype_ops = cyclonedds_sys::ddsi_sertype_ops {
    ...
    const SERDATA_OPS: cyclonedds_sys::ddsi_serdata_ops = cyclonedds_sys::ddsi_serdata_ops {
