...
pub unsafe extern "C" fn type_map<T>(
    ...
    let args = sertype;
    todo!("sertype_ops::type_map({args:#?})")
}
...
pub unsafe extern "C" fn type_info<T>(
    ...
    let args = sertype;
    todo!("sertype_ops::type_info({args:#?})");
}
    ...
    T: std::clone::Clone,
{
    ...
    todo!("sertype_ops::derive_sertype({args:#?})")
}
...
pub unsafe extern "C" fn get_serialized_size<T>(
    ...
    todo!("sertype_ops::get_serialized_size({args:#?})")
}
...
pub unsafe extern "C" fn serialize_into<T>(
    ...
    todo!("sertype_ops::serialize_into({args:#?})")
}
