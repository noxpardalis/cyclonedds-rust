...
bitflags::bitflags! {
    ...
    pub struct Status: cyclonedds_sys::dds_status_id_t {
        ...
        const InconsistentTopic =
            cyclonedds_sys::dds_status_id_DDS_INCONSISTENT_TOPIC_STATUS_ID;
        ...
        const LivelinessChanged =
            cyclonedds_sys::dds_status_id_DDS_LIVELINESS_CHANGED_STATUS_ID;
        /// The writer has found a reader that matches the topic and has a
        /// compatible QoS.
        const PublicationMatched =
            cyclonedds_sys::dds_status_id_DDS_PUBLICATION_MATCHED_STATUS_ID;
        /// The reader has found a writer that matches the topic and has a
        /// compatible QoS.
        const SubscriptionMatched =
            cyclonedds_sys::dds_status_id_DDS_SUBSCRIPTION_MATCHED_STATUS_ID;
    }
}
